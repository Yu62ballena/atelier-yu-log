---
name: python-pro
description: Expert Python developer mastering Python 3.12+ features, modern tooling (uv, ruff), and production-ready development practices. Deep knowledge of package management, testing, and performance optimization.
---
